...
class _LocationScreenState extends State<LocationScreen> {
  ...
  void _updateUI(dynamic weatherData) {
    setState(() {
      try {
        _tempmax = weatherData['main']['temp_max'].toDouble();
        _tempmin = weatherData['main']['temp_min'].toDouble();
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: RaisedButton(
                      ...
                      onPressed: (){
                        Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => WeatherBuilder().build()));
                      }),
                ),
                Container(
                  padding: EdgeInsets.all(25.0),
                        ...
                        children: <Widget>[
                          Expanded(
                            child: DetailCardWidget(
                              ...
                              cardText: 'Temp Max',
                              cardValue:
                                  '${_tempmax != null ? _tempmax.toInt() : _tempmax} °',
                            ),
                          ),
                          Expanded(
                            child: DetailCardWidget(
